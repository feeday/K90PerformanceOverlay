...
public class MainActivity extends Activity {
    ...
    private View buildUi() {
        ...
        title.setText("K90 性能悬浮监控 4.1 Stable");
        ...
        desc.setText("悬浮显示 CPU 占用 / CPU 频率 / CPU 温度 / GPU 温度 / 电池温度 / 内存。\n默认每 1 秒刷新，可拖动悬浮框。\n\nK90 / HyperOS 会限制普通 APK 读取 GPU 占用率和频率，因此稳定版不再显示这两项。");
        desc.setTextSize(15);
        ...
        hint.setText("红米 / 小米 HyperOS：如悬浮窗被系统回收，可在系统应用管理中允许后台运行并关闭本应用的省电限制。");
        hint.setTextSize(13);
